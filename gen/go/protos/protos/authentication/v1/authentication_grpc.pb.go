...
func (c *authenticationServiceClient) Authenticate(ctx context.Context, in *AuthenticationRequest, opts ...grpc.CallOption) (*AuthenticationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protos.authentication.v1.AuthenticationService/Authenticate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthenticationService_Authenticate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.authentication.v1.AuthenticationService/Authenticate",
	}
...
var AuthenticationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protos.authentication.v1.AuthenticationService",
	...
	Metadata: "protos/authentication/v1/authentication.proto",
}
